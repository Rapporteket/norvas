...
norvasPreprosess <- function(RegData) {
  ...
  if ('BvasPersistentTotal' %in% names(RegData)){
    indekser_kodebok <- which(kodebok_norvas$Variabelnavn == 'Sykdomsvurdering' & kodebok_norvas$skjema == 'Bvas'):
      (which(kodebok_norvas$Variabelnavn == varnavn$Variabelnavn[which(varnavn$Variabelnavn=='Sykdomsvurdering' & varnavn$skjema == 'Bvas')+1])-1)
  ...
  if ('AntallInfeksjoner' %in% names(RegData)){
    ...
    indekser_kodebok <- which(kodebok_norvas$Variabelnavn == 'AntallInfeksjoner' & kodebok_norvas$skjema == 'SelvrapportertAlvorligInfeksjon'):
      (which(kodebok_norvas$Variabelnavn == varnavn$Variabelnavn[which(varnavn$Variabelnavn=='AntallInfeksjoner' & varnavn$skjema == 'SelvrapportertAlvorligInfeksjon')+1])-1)
