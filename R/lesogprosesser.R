...
lesogprosesser <- function(rap_aar = 2024,
  ...
  Diagnoser <- read.table(
    ...
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Medisiner <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_MedisineringSkjema_2025-10-02_1411.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  MedisinerHistorisk <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_MedisineringHistoriskDoseSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  MedisinerInfusjonslogg <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_MedisineringInfusjonsLoggSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  BVAS <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_BvasSkjema_2025-10-02_1411.csv',
    header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  KERR <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_KerrsKriterierSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  VDI <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_VdiSkjema_2025-10-02_1411.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Labskjema <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_BlodprøvesvarSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Komorbid <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_KomorbidTilstandSkjema_2025-10-02_1411.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Pasientsvar <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_Svar+fra+pasienten_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  DiagnoseKriterier <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_Klassifikasjonskriterierskjema_2025-10-02_1412.csv',
    header=TRUE, sep=";",
    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Alvorlig_infeksjon <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_SelvrapportertAlvorligInfeksjonSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  Utredning <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_Utredning_2025-10-02_1412.csv',
    header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
  VaskulittIntervensjon <- read.table(
    'C:/regdata/norvas/datadump/DataDump_MRS-PROD_VaskulittIntervensjonSkjema_2025-10-02_1412.csv',
    header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
