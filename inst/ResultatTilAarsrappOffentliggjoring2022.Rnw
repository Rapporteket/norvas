...
Oppfolging <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_OppfølgingSkjema_2023-01-02_0917.csv', header=TRUE, sep=";",
                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
...
Utredning <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_Utredning_2023-01-02_0918.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Labskjema <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_BlodprøvesvarSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
