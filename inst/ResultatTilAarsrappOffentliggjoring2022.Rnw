...
Inklusjon <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_Inklusjonskjema_2023-01-02_0917.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# names(Inklusjon)[names(Inklusjon) == "Fødselsnummer"] <- "PasientGUID"
Oppfolging <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_OppfolgingSkjema_2023-01-02_0917.csv', header=TRUE, sep=";",
                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Diagnoser <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_DiagnoseSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Medisiner <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_MedisineringSkjema_2023-01-02_0917.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
BVAS <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_BvasSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
KERR <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_KerrsKriterierSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
VDI <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_VdiSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                  stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Alvorlig_infeksjon <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_SelvrapportertAlvorligInfeksjonSkjema_2023-01-02_0918.csv',
                                 header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Utredning <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_Utredning_2023-01-02_0918.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Labskjema <- read.table('C:/GIT/data/norvas/DataDump_MRS-PROD_BlodprovesvarSkjema_2023-01-02_0918.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
