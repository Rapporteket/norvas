...
print(xtable::xtable(
  reg3aar_shus, align= c('l','l',rep('r', dim(reg3aar_shus)[2]-1)),
...
## For pasienter som mangler registrering av medisiner leeges det til en rad
## med info om diagnose og inklusjonsdato, samt eksklusjonsstatus
...
Medisiner$LegemiddelGenerisk[Medisiner$LegemiddelGenerisk %in% c("Mycofenolat mofetil", "Mykofenolsyre")] <-
  "Mykofenolsyre" ## ???????
