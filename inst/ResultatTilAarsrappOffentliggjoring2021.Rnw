...
# Inklusjon <- read.table('~/data/norvas/DataDump_MRS-PROD_Inklusjonskjema_2022-04-05_0931.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# # names(Inklusjon)[names(Inklusjon) == "Fødselsnummer"] <- "PasientGUID"
# Oppfolging <- read.table('~/data/norvas/DataDump_MRS-PROD_OppfølgingSkjema_2022-04-05_0931.csv', header=TRUE, sep=";",
#                          stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Diagnoser <- read.table('~/data/norvas/DataDump_MRS-PROD_DiagnoseSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Medisiner <- read.table('~/data/norvas/DataDump_MRS-PROD_MedisineringSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# BVAS <- read.table('~/data/norvas/DataDump_MRS-PROD_BvasSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# KERR <- read.table('~/data/norvas/DataDump_MRS-PROD_KerrsKriterierSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# VDI <- read.table('~/data/norvas/DataDump_MRS-PROD_VdiSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Alvorlig_infeksjon <- read.table('~/data/norvas/DataDump_MRS-PROD_SelvrapportertAlvorligInfeksjonSkjema_2022-04-05_0932.csv',
#                                  header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Utredning <- read.table('~/data/norvas/DataDump_MRS-PROD_Utredning_2022-04-05_0932.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Labskjema <- read.table('~/data/norvas/DataDump_MRS-PROD_BlodprøvesvarSkjema_2022-04-05_0932.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')

# Inklusjon <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_Inklusjonskjema_2022-10-17_0929.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# # names(Inklusjon)[names(Inklusjon) == "Fødselsnummer"] <- "PasientGUID"
# Oppfolging <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_OppfølgingSkjema_2022-10-17_0929.csv', header=TRUE, sep=";",
#                          stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Diagnoser <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_DiagnoseSkjema_2022-10-17_0930.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Medisiner <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_MedisineringSkjema_2022-10-17_0929.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# BVAS <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_BvasSkjema_2022-10-17_0930.csv', header=TRUE, sep=";",
#                    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# KERR <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_KerrsKriterierSkjema_2022-10-17_0930.csv', header=TRUE, sep=";",
#                    stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# VDI <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_VdiSkjema_2022-10-17_0929.csv', header=TRUE, sep=";",
#                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Alvorlig_infeksjon <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_SelvrapportertAlvorligInfeksjonSkjema_2022-10-17_0930.csv',
#                                  header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Utredning <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_Utredning_2022-10-17_0930.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
# Labskjema <- read.table('~/data/norvas/qadata/DataDump_MRS-QA_BlodprøvesvarSkjema_2022-10-17_0930.csv', header=TRUE, sep=";",
#                         stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
...
Medisiner <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_MedisineringSkjema_2022-10-20_1507.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
BVAS <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_BvasSkjema_2022-10-20_1507.csv', header=TRUE, sep=";",
                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
KERR <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_KerrsKriterierSkjema_2022-10-20_1508.csv', header=TRUE, sep=";",
                   stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
VDI <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_VdiSkjema_2022-10-20_1507.csv', header=TRUE, sep=";",
                  stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Alvorlig_infeksjon <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_SelvrapportertAlvorligInfeksjonSkjema_2022-10-20_1508.csv',
                                 header=TRUE, sep=";", stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Utredning <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_Utredning_2022-10-20_1508.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
Labskjema <- read.table('~/data/norvas/proddata2022-10-20/DataDump_MRS-PROD_BlodprøvesvarSkjema_2022-10-20_1507.csv', header=TRUE, sep=";",
                        stringsAsFactors = F, fileEncoding = 'UTF-8-BOM')
...
figfolder <- "~/GIT/norvas/inst/Figurer/"
...
mtext(at=pos+0.00, text=grtxt, side=2, las=1, cex=cexgr, adj=1, line=0.25)
legend('bottomright', legend = norvas::wrap.it(paste0(names(registreringer)[-1], ", N=", colSums(registreringer[, -1])), 34), col = figinfo$farger[1:dim(plotMatrise)[1]],
       pch = 15, border = NA, bty='n')
...
% #
% # write.csv2(tmp, '~/data/norvas/depricated.csv', row.names = F)
%
%
