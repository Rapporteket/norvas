...
##############3333 UNDER ARBEID - RYDD OPP I MAPPING RESH ORGNR ####################
###################################################################################
SykehusNavnStruktur <- read.csv2("~/GIT/hospital.csv")
kobl_unitid_shusnavn_norvas <- data.frame(
  kobl_unitid_shusnavn_norvas,
  SykehusNavnStruktur[stringdist::amatch(kobl_unitid_shusnavn_norvas$Sykehusnavn,
                                         SykehusNavnStruktur$short_name ), ])

kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 104579] <- 974749025
kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 601159] <- 974795787
kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 700701] <- 974795361
kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 4210614] <- 974795515
kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 104209] <- 873255102

kobl_unitid_shusnavn_norvas$orgnr[kobl_unitid_shusnavn_norvas$UnitId == 102977]  974557746

kobl_unitid_shusnavn_norvas$hf_orgnr[kobl_unitid_shusnavn_norvas$UnitId == 104579] <- 883974832
kobl_unitid_shusnavn_norvas$hf_orgnr[kobl_unitid_shusnavn_norvas$UnitId == 601159] <- 983974899
kobl_unitid_shusnavn_norvas$hf_orgnr[kobl_unitid_shusnavn_norvas$UnitId == 700701] <- 983974910
kobl_unitid_shusnavn_norvas$hf_orgnr[kobl_unitid_shusnavn_norvas$UnitId == 4210614] <- 983974929
kobl_unitid_shusnavn_norvas$hf_orgnr[kobl_unitid_shusnavn_norvas$UnitId == 104209] <- 981275721

SykehusNavnStruktur[match(c(974749025, 974795787, 974795361,  974795515, 873255102), SykehusNavnStruktur$orgnr),]
