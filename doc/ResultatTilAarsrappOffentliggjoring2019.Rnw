...
# ikke_diagnose <- data.frame(PasientGUID=setdiff(Inklusjon$PasientGUID, Diagnoser$PasientGUID))
# ikke_diagnose$SkjemaGUID <- Inklusjon$SkjemaGUID[match(ikke_diagnose$PasientGUID, Inklusjon$PasientGUID)]
# write.csv2(ikke_diagnose, 'I:/norvas/mangler_diagnose_v2.csv', row.names = F)

#### HVIS SAMME PASIENT HAR OPPSTART MED SAMME LEGEMIDDEL PÅ SAMME DAG, VELG DEN MED TIDLIGST SLUTTDATO
tmp <- Medisiner %>%
  group_by(PasientGUID, StartDato, LegemiddelGenerisk) %>%
  summarise('ant_samme_startdato' = n(),
            SluttDato_min = min(SluttDato, na.rm = T),
            SkjemaGUID_min = if (is.na(which(SluttDato == min(SluttDato, na.rm = T))[1])) {SkjemaGUID[1]}
            else {SkjemaGUID[which(SluttDato == min(SluttDato, na.rm = T))[1]]})
...
outfile <- 'sykdomsvurdering2019.pdf'
...
outfile <- 'sykdomsvurdering2019_gr1.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2019-01-01' & BVAS$BVAS_Dato <= '2019-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=1,
...
outfile <- 'sykdomsvurdering2019_gr2.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2019-01-01' & BVAS$BVAS_Dato <= '2019-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=2,
...
outfile <- 'sykdomsvurdering2019_gr3.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2019-01-01' & BVAS$BVAS_Dato <= '2019-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=3,
...
#
# ######## gr. 1 ################
indMedisinert2019 <- which(((Medisiner$StartDato <= '2019-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2019-12-31' & Medisiner$SluttDato >= '2019-01-01')) & Medisiner$Diag_gr_nr == 1)
...
# ######## gr. 2 ANCA ################
indMedisinert2019 <- which(((Medisiner$StartDato <= '2019-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2019-12-31' & Medisiner$SluttDato >= '2019-01-01')) & Medisiner$Diag_gr_nr == 2)
...
indMedisinert2019 <- which(((Medisiner$StartDato <= '2019-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2019-12-31' & Medisiner$SluttDato >= '2019-01-01')) & Medisiner$Diag_gr_nr == 3)
...
ant_pas_pr_med_foer2019 <- Medisiner[Medisiner$StartDato < '2019-01-01', ] %>% group_by(LegemiddelGenerisk) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_foer2019 <- length(unique(Medisiner[Medisiner$StartDato < '2019-01-01', "PasientGUID"]))
indMedisinert_foer2019 <- which(Medisiner$StartDato < '2019-01-01')
...
ant_pas_pr_med_2019 <- Medisiner[(Medisiner$SluttDato >= '2019-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', ] %>% group_by(LegemiddelGenerisk) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_2019 <- length(unique(Medisiner[(Medisiner$SluttDato >= '2019-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', "PasientGUID"]))

indMedisinert2019 <- which((Medisiner$SluttDato >= '2019-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01')
pid_Medisinert2019 <- unique(Medisiner$PasientGUID[indMedisinert2019])
...
ant_pas_pr_med_foer2019 <- Medisiner[Medisiner$StartDato < '2019-01-01', ] %>% group_by(Legemiddelgruppe) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_foer2019 <- length(unique(Medisiner[Medisiner$StartDato < '2019-01-01', "PasientGUID"]))
indMedisinert_foer2019 <- which(Medisiner$StartDato < '2019-01-01')
pid_Medisinert_foer2019 <- unique(Medisiner$PasientGUID[indMedisinert_foer2019])
pid_oppfolging_foer2019 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar<2019])
...
ant_pas_pr_med_2019 <- Medisiner[(Medisiner$SluttDato >= '2019-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', ] %>% group_by(Legemiddelgruppe) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_2019 <- length(unique(Medisiner[(Medisiner$SluttDato >= '2019-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', "PasientGUID"]))
...
anca_debut_v2 <- Ind1_ANCAvdebut_NorVas[Ind1_ANCAvdebut_NorVas$Aar <=2019, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())
...
anca_debut_v2 <- bind_rows(anca_debut_v2[, c(4,2,3)], c(Sykehusnavn = 'Totalt', Ind1_ANCAvdebut_NorVas[Ind1_ANCAvdebut_NorVas$Aar <=2019, ] %>% summarise(Andel = sum(Teller)/sum(Nevner)*100, N=n())))
...
remisjon <- BVAS_utvalg[which(BVAS_utvalg$Sykdomsvurdering == "Remisjon" & BVAS_utvalg$BVAS_Dato <= "2019-12-31"), ]
...
pas_paaprednisolon <- ind6_AndelANCA_Prednisolon_NorVas[ind6_AndelANCA_Prednisolon_NorVas$Aar <=2019, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())
...
bvas_tb <- BVAS_tmp[BVAS_tmp$BVAS_Dato >= '2019-01-01' & BVAS_tmp$BVAS_Dato < '2020-01-01', ] %>% group_by(Sykdomsvurdering, Sykehusnavn) %>% summarise(gjsn.bvas = mean(bvas_samlet), N = n())
...
aux <- BVAS[BVAS$Sykdomsvurdering %in% c('Debut', 'AlvorligResidiv', 'LettResidiv') & BVAS$BVAS_Dato >= "2019-01-01" & BVAS$BVAS_Dato <= "2019-12-31", ]
...
aux <- Alvorlig_infeksjon2019 %>% group_by(PasientGUID, Sykehusnavn) %>% summarise(ant.pr.pas = sum(AntallInfeksjoner_num), N=n())
...
type_infeksjoner <- colSums(Alvorlig_infeksjon2019[, c('OvreLuftveier', 'NedreLuftveier', 'Urinveier',
...
## 2019:
# rad1<- colMeans(Inklusjon[Inklusjon$FormDate >= '2019-01-01' &  Inklusjon$FormDate <='2019-12-31', c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
# rad2<- colMeans(Oppfolging[Oppfolging$FormDate >= '2019-01-01' &  Oppfolging$FormDate <='2019-12-31', c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
#
# rad3<- colMeans(Inklusjon[Inklusjon$FormDate >= '2019-01-01' &  Inklusjon$FormDate <='2019-12-31' & Inklusjon$Tretthet!=0 & Inklusjon$PasientGlobalSykdomsaktivitet!=0 & Inklusjon$Pasientsmerter!=0,
#                    c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
# rad4<- colMeans(Oppfolging[Oppfolging$FormDate >= '2019-01-01' &  Oppfolging$FormDate <='2019-12-31' & Oppfolging$Tretthet!=0 & Oppfolging$PasientGlobalSykdomsaktivitet!=0 & Oppfolging$Pasientsmerter!=0,
#                     c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
...
rad3<- colMeans(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0,
                   c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
rad4<- colMeans(Oppfolging2019[Oppfolging2019$Tretthet!=0 & Oppfolging2019$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2019$Pasientsmerter!=0,
                    c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
...
tesres1_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], Oppfolging2019[Oppfolging2019$Tretthet!=0 & Oppfolging2019$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2019$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], alternative = 'greater')

tesres2_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], Oppfolging2019[Oppfolging2019$Tretthet!=0 & Oppfolging2019$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2019$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], alternative = 'greater')

tesres3_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], Oppfolging2019[Oppfolging2019$Tretthet!=0 & Oppfolging2019$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2019$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], alternative = 'greater')
...
Medisiner$SluttDato_dum <- Medisiner$SluttDato
Medisiner$SluttDato_dum[is.na(Medisiner$SluttDato_dum)] <- '2020-02-07'

Medisiner$tid_paa_med <- difftime(Medisiner$SluttDato_dum, Medisiner$StartDato, units = 'days')
