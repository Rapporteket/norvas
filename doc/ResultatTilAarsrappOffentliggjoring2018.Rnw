...
\title{Figurer og tabeller til årsrapport for Norvas 2018}
\author{Norvas}
...
## Betanien og Martina Hansen skal ikke være med i rapport for 2018
Inklusjon <- Inklusjon[!(Inklusjon$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Oppfolging <- Oppfolging[!(Oppfolging$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Diagnoser <- Diagnoser[!(Diagnoser$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Medisiner <- Medisiner[!(Medisiner$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
BVAS <- BVAS[!(BVAS$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
KERR <- KERR[!(KERR$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
VDI <- VDI[!(VDI$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Alvorlig_infeksjon <- Alvorlig_infeksjon[!(Alvorlig_infeksjon$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Utredning <- Utredning[!(Utredning$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]
Labskjema <- Labskjema[!(Labskjema$Sykehusnavn %in% c('Betanien', 'Martina Hansen', 'Rikshospitalet')), ]

Inklusjon$Sykehusnavn <- as.factor(as.character(Inklusjon$Sykehusnavn))
Oppfolging$Sykehusnavn <- as.factor(as.character(Oppfolging$Sykehusnavn))
Diagnoser$Sykehusnavn <- as.factor(as.character(Diagnoser$Sykehusnavn))
Medisiner$Sykehusnavn <- as.factor(as.character(Medisiner$Sykehusnavn))
BVAS$Sykehusnavn <- as.factor(as.character(BVAS$Sykehusnavn))
KERR$Sykehusnavn <- as.factor(as.character(KERR$Sykehusnavn))
VDI$Sykehusnavn <- as.factor(as.character(VDI$Sykehusnavn))
Alvorlig_infeksjon$Sykehusnavn <- as.factor(as.character(Alvorlig_infeksjon$Sykehusnavn))
Utredning$Sykehusnavn <- as.factor(as.character(Utredning$Sykehusnavn))
Labskjema$Sykehusnavn <- as.factor(as.character(Labskjema$Sykehusnavn))
...
# Medisiner[which(Medisiner$LegemiddelType=='AnnetImportert'), c("Legemiddel", "LegemiddelGenerisk")]
...
<<'Tab: bakgrunnsdata', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=
datoTil='2018-12-31'
datoFra='1914-01-01'
erMann=99
reshID=601159
...
outfile <- 'sykdomsvurdering.pdf'
valgtVar <- 'Sykdomsvurdering'
datovar='BVAS_Dato'
norvasFigAndeler(RegData=BVAS, valgtVar=valgtVar, datoFra=datoFra, datoTil='2017-12-31',
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
...
outfile <- 'sykdomsvurdering2018.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2018-01-01' & BVAS$BVAS_Dato <= '2018-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=99,
                        valgtShus=valgtShus,hentData=hentData, datovar=datovar, aldervar=aldervar, inkl_N = T)

outfile <- 'sykdomsvurdering2018_gr1.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2018-01-01' & BVAS$BVAS_Dato <= '2018-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=1,
...
outfile <- 'sykdomsvurdering2018_gr2.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2018-01-01' & BVAS$BVAS_Dato <= '2018-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=2,
...
outfile <- 'sykdomsvurdering2018_gr3.pdf'
norvasFigAndeler(RegData=BVAS[BVAS$BVAS_Dato >= '2018-01-01' & BVAS$BVAS_Dato <= '2018-12-31', ], valgtVar=valgtVar,
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=3,
...
## Se på mulighet for å sammenligne sykehus Stabel i Wenches årsrapport. Kun for HF med mer enn 50 registreringer i 2018.
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{sykdomsvurdering2018.pdf}
\caption{Sykdomsvurdering 2018}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{sykdomsvurdering2018_gr1.pdf}
\caption{Sykdomsvurdering 2018, gruppe 1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{sykdomsvurdering2018_gr2.pdf}
\caption{Sykdomsvurdering 2018, gruppe 2}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{sykdomsvurdering2018_gr3.pdf}
\caption{Sykdomsvurdering 2018, gruppe 3}
\end{figure}


<<'Tab: registreringer', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=
# x11()
registreringer <- Inklusjon %>% group_by(Sykehusnavn) %>% summarise('Foer2018' = sum(Inklusjonsaar<2018),
                                                  'aar2018' = sum(Inklusjonsaar==2018))
...
legend('bottomright', legend = c(paste0('T.o.m. 2017, N=', sum(registreringer$Foer2018)), paste0('2018, N=', sum(registreringer$aar2018))), col = figinfo$farger[c(3,1)], pch = 15, border = NA, bty='n')
title(main = 'Antall inklusjoner pr. HF')
if ( outfile != '') {dev.off()}

oppfolginger <- Oppfolging %>% group_by(Sykehusnavn) %>% summarise('Foer2018' = sum(Oppfolgingsaar<2018),
                                                  'aar2018' = sum(Oppfolgingsaar==2018))
oppfolginger <- oppfolginger[order(rowSums(oppfolginger[,2:3]), decreasing = F), ]

plotMatrise <- t(as.matrix(oppfolginger[,c(2,3)]))[c(2,1), ]
colnames(plotMatrise) <- rep('', dim(plotMatrise)[2])
outfile <- 'oppfolginger.pdf'
# outfile <- ''
...
# pos <- barplot(plotMatrise, beside = T, horiz = T, col = figinfo$farger[c(1,3)], border=NA, xlab="Antall pasienter")
# mtext(at=colMeans(pos)+0.00, text=grtxt, side=2, las=1, cex=cexgr, adj=1, line=0.25)
legend('bottomright', legend = c(paste0('T.o.m. 2017, N=', sum(oppfolginger$Foer2018)), paste0('2018, N=', sum(oppfolginger$aar2018))), col = figinfo$farger[c(3,1)], pch = 15, border = NA, bty='n')
...
<<'Tab: Andel pas. som har brukt med. grupper.', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=

# indMedisinert2018 <- which((Medisiner$StartDato <= '2018-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2018-12-31' & Medisiner$SluttDato >= '2018-01-01'))
#
# pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
# pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018])
#
# pid_alle_pas2018 <- unique(c(pid_Medisinert2018, pid_oppfolging2018))
#
# ant_pas_pr_med <- Medisiner[indMedisinert2018, ] %>% group_by(Sykehusnavn, Legemiddelgruppe) %>%
#   summarise(Antall = length(unique(PasientGUID))) %>% ungroup() %>% spread(key=Legemiddelgruppe, value = Antall)
# N <- Inklusjon[Inklusjon$PasientGUID %in% pid_alle_pas2018, ] %>% group_by(Sykehusnavn) %>% summarise(N=n())
# ant_pas_pr_med$N <- N$N
# ant_pas_pr_med_alle <-ant_pas_pr_med
#
# ######## gr. 1 ################
indMedisinert2018 <- which(((Medisiner$StartDato <= '2018-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2018-12-31' & Medisiner$SluttDato >= '2018-01-01')) & Medisiner$Diag_gr_nr == 1)

pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018 & Oppfolging$Diag_gr_nr==1])
pid_inkludert2018 <- unique(Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar<=2018 & Inklusjon$Diag_gr_nr == 1])

pid_alle_pas2018 <- unique(c(pid_Medisinert2018, pid_oppfolging2018, pid_inkludert2018))
...
retn <- 'H'
cexgr <- 1
outfile <- 'Kortikosteroider_gr1.pdf'
# outfile<-''
...
if ( outfile != '') {dev.off()}
#
# outfile <- 'Cyclofosfamid_gr1.pdf'
# figinfo <- rapFigurer::figtype(outfile = outfile)
# par('fig'=c(vmarg, 1, 0, 1))
# pos <- barplot(ant_pas_pr_med_gr1$Cyclofosfamid/ant_pas_pr_med_gr1$N*100, horiz = T, col = figinfo$farger[1], border=NA, xlab="Andel pasienter (%)")
# mtext(at=pos+0.00, text=paste0(grtxt, ' (N=', ant_pas_pr_med_gr1$N, ')'), side=2, las=1, cex=cexgr, adj=1, line=0.25)
# title(main = 'Cyclofosfamid, storkarsvaskulitter')
# if ( outfile != '') {dev.off()}

# outfile <- 'Rituximab_gr1.pdf'
# figinfo <- rapFigurer::figtype(outfile = outfile)
# par('fig'=c(vmarg, 1, 0, 1))
# pos <- barplot(ant_pas_pr_med_gr1$Rituximab/ant_pas_pr_med_gr1$N*100, horiz = T, col = figinfo$farger[1], border=NA, xlab="Andel pasienter (%)")
# mtext(at=pos+0.00, text=paste0(grtxt, ' (N=', ant_pas_pr_med_gr1$N, ')'), side=2, las=1, cex=cexgr, adj=1, line=0.25)
# title(main = 'Rituximab, storkarsvaskulitter')
# if ( outfile != '') {dev.off()}

outfile <- 'Biologiske_gr1.pdf'
figinfo <- rapFigurer::figtype(outfile = outfile)
par('fig'=c(vmarg, 1, 0, 1))
...
# ######## gr. 2 ANCA ################
indMedisinert2018 <- which(((Medisiner$StartDato <= '2018-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2018-12-31' & Medisiner$SluttDato >= '2018-01-01')) & Medisiner$Diag_gr_nr == 2)

pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018 & Oppfolging$Diag_gr_nr == 2])
pid_inkludert2018 <- unique(Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar<=2018 & Inklusjon$Diag_gr_nr == 2])
...
retn <- 'H'
cexgr <- 0.8
outfile <- 'Kortikosteroider_gr2.pdf'
...
indMedisinert2018 <- which(((Medisiner$StartDato <= '2018-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2018-12-31' & Medisiner$SluttDato >= '2018-01-01')) & Medisiner$Diag_gr_nr == 3)

pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018 & Oppfolging$Diag_gr_nr == 3])
pid_inkludert2018 <- unique(Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar<=2018 & Inklusjon$Diag_gr_nr == 3])
...
retn <- 'H'
cexgr <- 0.8
outfile <- 'Kortikosteroider_gr3.pdf'
...
# indMedisinert2018 <- which(((Medisiner$StartDato <= '2018-12-31' & is.na(Medisiner$SluttDato)) | (Medisiner$StartDato <= '2018-12-31' & Medisiner$SluttDato >= '2018-01-01')) & Medisiner$Diag_gr_nr %in% 2:3)
#
# pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
# pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018 & Oppfolging$Diag_gr_nr %in% 2:3])
#
# pid_alle_pas2018 <- unique(c(pid_Medisinert2018, pid_oppfolging2018))
#
# ant_pas_pr_med <- Medisiner[indMedisinert2018, ] %>% group_by(Sykehusnavn, Legemiddelgruppe) %>%
...
# ant_pas_pr_med$N <- N$N
#
# ant_pas_pr_med_gr2_3 <-ant_pas_pr_med
#
# ####### print
#
#
# print(xtable::xtable(ant_pas_pr_med_alle, align= c('l','l',rep('R{0.5in}', ncol(ant_pas_pr_med_alle)-1)), caption='Antall pasienter på oppgitte medisingrupper i 2018'), include.rownames = F)
#
# print(xtable::xtable(ant_pas_pr_med_gr1, align= c('l','l',rep('R{0.5in}', ncol(ant_pas_pr_med_gr1)-1)), caption='Antall pasienter i diagnosegruppe 1 på oppgitte medisingrupper i 2018'), include.rownames = F)
#
# print(xtable::xtable(ant_pas_pr_med_gr2_3, align= c('l','l',rep('R{0.5in}', ncol(ant_pas_pr_med_gr2_3)-1)), caption='Antall pasienter i diagnosegruppe 2 eller 3 på oppgitte medisingrupper i 2018'), include.rownames = F)
#


## For gruppe 2, nasjonalt: Forbruk t.o.m. 2017 og forbruk i 2018 for Rituximab og Cyclofosfamid

## Vurder om det skal fremstilles

# Antall pasienter som er eller har vært på gjeldende medisin

ant_pas_pr_med_foer2018 <- Medisiner[Medisiner$StartDato < '2018-01-01', ] %>% group_by(LegemiddelGenerisk) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_foer2018 <- length(unique(Medisiner[Medisiner$StartDato < '2018-01-01', "PasientGUID"]))
indMedisinert_foer2018 <- which(Medisiner$StartDato < '2018-01-01')
pid_Medisinert_foer2018 <- unique(Medisiner$PasientGUID[indMedisinert_foer2018])
pid_oppfolging_foer2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar<2018])
pid_inkludert_foer2018 <- unique(Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar<2018])
N_foer2018 <- length(unique(c(pid_Medisinert_foer2018, pid_oppfolging_foer2018, pid_inkludert_foer2018)))

ant_pas_pr_med_2018 <- Medisiner[(Medisiner$SluttDato >= '2018-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', ] %>% group_by(LegemiddelGenerisk) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_2018 <- length(unique(Medisiner[(Medisiner$SluttDato >= '2018-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', "PasientGUID"]))

indMedisinert2018 <- which((Medisiner$SluttDato >= '2018-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01')
pid_Medisinert2018 <- unique(Medisiner$PasientGUID[indMedisinert2018])
pid_oppfolging2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar==2018])
pid_inkludert2018 <- unique(Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar<=2018])
N_2018 <- length(unique(c(pid_Medisinert2018, pid_oppfolging2018, pid_inkludert2018)))

ant_pas_pr_med <- merge(ant_pas_pr_med_foer2018, ant_pas_pr_med_2018, by = 'LegemiddelGenerisk', all = T)

ant_pas_pr_med$andel_foer2018 <- ant_pas_pr_med$Antall.x/N_foer2018*100
ant_pas_pr_med$andel_2018 <- ant_pas_pr_med$Antall.y/N_2018*100

ant_pas_pr_med <- ant_pas_pr_med[order(ant_pas_pr_med$andel_2018, decreasing = F), ]
...
retn <- 'H'
cexgr <- 0.8
plotMatrise <- t(as.matrix(ant_pas_pr_med[,c("andel_foer2018", "andel_2018")]))[c(2,1), ]
colnames(plotMatrise) <- rep('', dim(plotMatrise)[2])
outfile <- 'pasPaaMedisin.pdf'
# outfile <- ''
...
mtext(at=colMeans(pos)+0.00, text=grtxt, side=2, las=1, cex=cexgr, adj=1, line=0.25)
legend('bottomright', legend = c(paste0('T.o.m. 2017, N=', N_foer2018), paste0('2018, N=', N_2018)),
...
ant_pas_pr_med_foer2018 <- Medisiner[Medisiner$StartDato < '2018-01-01', ] %>% group_by(Legemiddelgruppe) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_foer2018 <- length(unique(Medisiner[Medisiner$StartDato < '2018-01-01', "PasientGUID"]))
indMedisinert_foer2018 <- which(Medisiner$StartDato < '2018-01-01')
pid_Medisinert_foer2018 <- unique(Medisiner$PasientGUID[indMedisinert_foer2018])
pid_oppfolging_foer2018 <- unique(Oppfolging$PasientGUID[Oppfolging$Oppfolgingsaar<2018])
...
ant_pas_pr_med_2018 <- Medisiner[(Medisiner$SluttDato >= '2018-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', ] %>% group_by(Legemiddelgruppe) %>% summarise(Antall = length(unique(PasientGUID))) %>% ungroup()
# N_2018 <- length(unique(Medisiner[(Medisiner$SluttDato >= '2018-01-01' | is.na(Medisiner$SluttDato)) & Medisiner$StartDato < '2019-01-01', "PasientGUID"]))
...
ant_pas_pr_med <- merge(ant_pas_pr_med_foer2018, ant_pas_pr_med_2018, by = 'Legemiddelgruppe', all = T)
...
til_register$N_foer2018 <- N_foer2018
til_register$N_2018 <- N_2018
names(til_register)[2:3] <- c('Antall_foer2018', 'Antall_2018')
...
\caption{Andel pasienter på de forskjellige medisingruppene t.o.m. 2017 og i løpet av 2018. For å telles som å være på en medisin i første gruppen skal medisinskjemaet ha registrert medisinering med startdato før 2018 for gitt medisin. Nevneren er antall unike pasienter som finnes i inklusjonskjema, oppfølgingsskjema eller medisineringsskjema før 2018.  For å telles som å være på medisin i 2018-gruppen skal medisinskjemaet ha en medisinering med startdato i løpet av 2018 eller før, OG enten sluttdato i 2018 eller seinere ELLER ingen sluttdato. Nevneren er antall unike pasienter som finnes i inklusjonskjema eller oppfølgingsskjema med henholdsvis inklusjonsdato eller oppfølgingsdato i 2018, i tillegg til alle som har en medisinering med startdato i løpet av 2018 eller før, OG enten sluttdato i 2018 eller seinere ELLER ingen sluttdato. MERK: Vi mangler per nå en måte å fjerne pasienter som ikke finnes i registeret etter en viss dato.}
...
\caption{Utvalg som i Figur \ref{medisin_figur_alle} for 2018.}
\end{figure}
...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{Cyclofosfamid_gr1.pdf}
% \caption{Utvalg som i Figur \ref{medisin_figur_alle} for 2018.}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{Rituximab_gr1.pdf}
% \caption{Utvalg som i Figur \ref{medisin_figur_alle} for 2018.}
% \end{figure}
...
<<'Tab: Oppf.pr.pas.', results='asis', echo=FALSE>>=
...
teller <- addmargins(table(OppfMedDiagnose[OppfMedDiagnose$PasientGUID %in% Inklusjon$PasientGUID[Inklusjon$Inklusjonsaar < 2018] &
                                  OppfMedDiagnose$Oppfolgingsaar==2018, c("Sykehusnavn", "Diag_gr")]), 1)
nevner <- addmargins(table(Inklusjon[Inklusjon$Inklusjonsaar < 2018, c("Sykehusnavn", "Diag_gr")]), 1)
...
print(xtable::xtable(Gj.sn_ant_oppf_pr_pasient_pr_hf, align= c('l','r','r','r'), caption='Gjennomsnittlig antall oppfølginger per pasient. Tallene i parantes angir antall pasienter aktuell for oppfølging, dvs. inkludert før 2018'), include.rownames = T)
...
min2oppf <- ind2_Andelminimum_2oppf_NorVas[ind2_Andelminimum_2oppf_NorVas$Oppfolgingsaar ==2018, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())
...
min2oppf <- bind_rows(min2oppf[, c(4,2,3)], c(Sykehusnavn = 'Totalt', ind2_Andelminimum_2oppf_NorVas[ind2_Andelminimum_2oppf_NorVas$Oppfolgingsaar ==2018, ] %>% summarise(Andel = sum(Teller)/sum(Nevner)*100, N=sum(Nevner))))


print(xtable::xtable(min2oppf, align= c('l','l','r','r'), digits=c(0, 0,1,0), caption='Andel aktuelle for oppfølging i 2018 med minimum 2 oppfølginger. N skiller seg fra forrige tabell siden ikke alle pasienter fra inklusjons- og oppfølgingsskjema finnes i diagnoseskjema.'), include.rownames = F)
...
<<'Tab: Antall nysyke', results='asis', echo=FALSE>>=

nysyke <- Inklusjon[which(abs(difftime(Inklusjon$Diagnose_Klinisk_Dato, Inklusjon$InklusjonDato, units = 'days')) <= 30), ]

ant_nysyke2018 <-  as.data.frame(table(nysyke$Diag_gr[nysyke$Inklusjonsaar==2018]))
names(ant_nysyke2018) <- c('Diagnosegruppe', 'Antall')
print(xtable::xtable(ant_nysyke2018, align= c('l','l','r'), caption='Antall nysyke 2018'), include.rownames = F)
...
# tmp2 %>% group_by(Oppfolgingsaar) %>% summarise(andeloppf = sum(!is.na(bvas_samlet))/length(bvas_samlet)*100,
                                                # N = n())
Tabell_bvas_oppf <- tmp2[tmp2$Oppfolgingsaar==2018, ] %>% group_by(Sykehusnavn) %>% summarise(andeloppf = sum(!is.na(bvas_samlet))/length(bvas_samlet)*100, N = n())

# total <- tibble(Sykehusnavn= 'Totalt',
#                 andeloppf = sum(!is.na(tmp2[tmp2$Oppfolgingsaar==2018, 'bvas_samlet']))/length(tmp2[tmp2$Oppfolgingsaar==2018, 'bvas_samlet'])*100,
#                 N = length(tmp2[tmp2$Oppfolgingsaar==2018, 'bvas_samlet']))
total <- tibble(Sykehusnavn= 'Totalt',
...
print(xtable::xtable(Tabell_bvas_oppf, align= c('l','l','r','r'), digits=c(0,0,1,0), caption='Andel med utført BVAS ved oppfølging i 2018, ANCA assosierte vaskulitter'), include.rownames = F)
...
Tabell_kerr_oppf <- tmp3[tmp3$Oppfolgingsaar==2018, ] %>% group_by(Sykehusnavn) %>% summarise(andeloppf = sum(!is.na(KerrsKriterierScore))/length(KerrsKriterierScore)*100, N = n())
...
print(xtable::xtable(Tabell_kerr_oppf, align= c('l','l','r','r'), digits=c(0,0,1,0), caption='Andel med utført KERR ved oppfølging i 2018, gr. 1'), include.rownames = F)
...
anca_debut_v2 <- Ind1_ANCAvdebut_NorVas[Ind1_ANCAvdebut_NorVas$Aar <=2018, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())

anca_debut_v2$Sykehusnavn <- kobl_unitid_shusnavn_norvas$Sykehusnavn[match(anca_debut_v2$UnitId, kobl_unitid_shusnavn_norvas$UnitId)]
anca_debut_v2 <- anca_debut_v2[order(anca_debut_v2$Sykehusnavn), ]
anca_debut_v2 <- bind_rows(anca_debut_v2[, c(4,2,3)], c(Sykehusnavn = 'Totalt', Ind1_ANCAvdebut_NorVas[Ind1_ANCAvdebut_NorVas$Aar <=2018, ] %>% summarise(Andel = sum(Teller)/sum(Nevner)*100, N=n())))


print(xtable::xtable(anca_debut_v2, align= c('l','l','r','r'), digits=c(0, 0,1,0), caption='Andel ANCA test ved debut for gruppe 2.'), include.rownames = F)
...
nysyke <- nysyke[which(nysyke$Sykdomsvurdering == 'Debut' & nysyke$Diag_gr_nr==2), ]
nysyke <- nysyke[which(nysyke$BVAS_Dato <= "2018-12-31"), ]
...
remisjon <- BVAS_utvalg[which(BVAS_utvalg$Sykdomsvurdering == "Remisjon" & BVAS_utvalg$BVAS_Dato <= "2018-12-31"), ]
...
print(xtable::xtable(andel_remisjon_6mnd, align= c('l','l','r','r'), digits=c(0,0,1,0), caption='Andel i remisjon ved 6 måneder ut fra BVAS for ANCA assosiert vaskulitter før 2019. Gjelder nysyke som definert ved at bvasdato ved debut og inklusjonsdato er innenfor plussminus 30 dager.'), include.rownames = F)
...
<<'Tab: andel pred.dose mindre enn x', results='asis', echo=FALSE>>=
...
PaaPrednisolon$MndFraDebut_6[which((PaaPrednisolon$BVAS_Dato %m+% months(7) >= PaaPrednisolon$StartDato & PaaPrednisolon$BVAS_Dato %m+% months(7) <= PaaPrednisolon$SluttDato) |
                                  (PaaPrednisolon$BVAS_Dato %m+% months(7) >= PaaPrednisolon$StartDato & is.na(PaaPrednisolon$SluttDato)))] <- 1
...
PaaPrednisolon$Mengde[PaaPrednisolon$PasientGUID.x %in% row.names(indikator_med6mnd[indikator_med6mnd$`1`==0, ])] <- 0
...
# andel5mg_pred <- sum(PaaPrednisolon$Mengde <= 5)/dim(PaaPrednisolon)[1]*100
# N_5mg <- dim(PaaPrednisolon)[1]


################ Data til Resultatportalen ###################################

ind6_AndelANCA_Prednisolon_NorVas <- PaaPrednisolon[, c("UnitId.x", "BVAS_aar", "Mengde")]
ind6_AndelANCA_Prednisolon_NorVas$Teller <- as.numeric(PaaPrednisolon$Mengde <= 5)
...
pas_paaprednisolon <- ind6_AndelANCA_Prednisolon_NorVas[ind6_AndelANCA_Prednisolon_NorVas$Aar <=2018, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())
...
pas_paaprednisolon <- bind_rows(pas_paaprednisolon[, c(4,2,3)], c(Sykehusnavn = 'Totalt', ind6_AndelANCA_Prednisolon_NorVas[ind6_AndelANCA_Prednisolon_NorVas$Aar <=2018, ] %>% summarise(Andel = sum(Teller)/sum(Nevner)*100, N=n())))
...
PaaPrednisolon <- merge(nysyke, prednisolon, by='HovedskjemaGUID', all.x = T)
PaaPrednisolon$MndFraDebut_6 <- 0
PaaPrednisolon$MndFraDebut_6[which((PaaPrednisolon$BVAS_Dato %m+% months(7) >= PaaPrednisolon$StartDato & PaaPrednisolon$BVAS_Dato %m+% months(7) <= PaaPrednisolon$SluttDato) | (PaaPrednisolon$BVAS_Dato %m+% months(7) >= PaaPrednisolon$StartDato & is.na(PaaPrednisolon$SluttDato)))] <- 1
...
# andel7mg_pred <- sum(PaaPrednisolon$Mengde <= 7.5)/dim(PaaPrednisolon)[1]*100
# N_7mg <- dim(PaaPrednisolon)[1]

################ Data til Resultatportalen ###################################

ind7_Andelstorvas_Prednisolon_NorVas <- PaaPrednisolon[, c("UnitId.x", "BVAS_aar", "Mengde")]
ind7_Andelstorvas_Prednisolon_NorVas$Teller <- as.numeric(PaaPrednisolon$Mengde <= 7.5)
...
pas_paaprednisolon <- ind7_Andelstorvas_Prednisolon_NorVas[ind7_Andelstorvas_Prednisolon_NorVas$Aar <=2018, ] %>% group_by(UnitId) %>% summarise(Andel = sum(Teller)/sum(Nevner)*100,
                                                          N=n())

pas_paaprednisolon$Sykehusnavn <- kobl_unitid_shusnavn_norvas$Sykehusnavn[match(pas_paaprednisolon$UnitId, kobl_unitid_shusnavn_norvas$UnitId)]
pas_paaprednisolon <- pas_paaprednisolon[order(pas_paaprednisolon$Sykehusnavn), ]
pas_paaprednisolon <- bind_rows(pas_paaprednisolon[, c(4,2,3)], c(Sykehusnavn = 'Totalt', ind7_Andelstorvas_Prednisolon_NorVas[ind7_Andelstorvas_Prednisolon_NorVas$Aar <=2018, ] %>% summarise(Andel = sum(Teller)/sum(Nevner)*100, N=n())))
...
print(xtable::xtable(indikator_predni, align= c('l','l','r', 'r'), digits=c(0,0,1,0), caption='Pga. få registreringer av variabler som inngår i indikator er alle aktuelle pasienter inkludert, ikke bare de medisinert i 2018.'), include.rownames = F)

@


<<'Tab: sykdomsvurdering', results='asis', echo=FALSE>>=
BVAS_tmp <- BVAS[BVAS$Diag_gr_nr==2, ]

bvas_tb <- BVAS_tmp[BVAS_tmp$BVAS_Dato >= '2018-01-01' & BVAS_tmp$BVAS_Dato < '2019-01-01', ] %>% group_by(Sykdomsvurdering, Sykehusnavn) %>% summarise(gjsn.bvas = mean(bvas_samlet), N = n())
...
print(xtable::xtable(bvas_tb, align= c('l','l',rep('r', ncol(bvas_tb)-1)), caption='Gjennomsnittlig BVAS score ANCA assosiert vaskulitter 2018'), include.rownames = F)


aux <- BVAS[BVAS$Sykdomsvurdering %in% c('Debut', 'AlvorligResidiv', 'LettResidiv') & BVAS$BVAS_Dato >= "2018-01-01" & BVAS$BVAS_Dato <= "2018-12-31", ]
...
Alvorlig_infeksjon2018 <- Alvorlig_infeksjon[Alvorlig_infeksjon$SelvrapportertAlvorligInfeksjon_Registrert_Dato >= '2018-01-01' &
                                               Alvorlig_infeksjon$SelvrapportertAlvorligInfeksjon_Registrert_Dato <= '2018-12-31', ]

# length(unique(Alvorlig_infeksjon2018$PasientGUID))

aux <- Alvorlig_infeksjon2018 %>% group_by(PasientGUID, Sykehusnavn) %>% summarise(ant.pr.pas = sum(AntallInfeksjoner_num), N=n())
...
print(xtable::xtable(tmp, align= c('l','l',rep('r', ncol(tmp)-1)), digits=c(0,0,1,0,0), caption='Gjennomsnittlig antall infeksjoner per pasient i 2018. Inkluderer alle pasienter med registreringer i 2018 på skjemaet Alvorligeinfeksjoner. Denne underestimerer muligens tallet siden også pasienter inkludert sent på året er med i utvalget. I tillegg gis registreringer i kategorien \\txtit{4 eller flere} verdien 4.'), include.rownames = F)

@


<<'Fig: Alvorlige infeksjoner', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=


########### Legg til eksisterende figur
# x11()
outfile <- 'alvorlig_infeksjon.pdf'
norvasFigAndeler(RegData=Alvorlig_infeksjon2018, valgtVar='AntallInfeksjoner_kummulativ',
                 datoFra=datoFra, datoTil=datoTil,
                        minald=minald, maxald=maxald, erMann=erMann, outfile=outfile, reshID=reshID,
                 enhetsUtvalg=enhetsUtvalg, preprosess=preprosess, diag_gruppe=99,
...
type_infeksjoner <- colSums(Alvorlig_infeksjon2018[, c('OvreLuftveier', 'NedreLuftveier', 'Urinveier',
...
\caption{Fordeling av antall alvorlige infeksjoner meldt i 2018}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{type_infeksjoner.pdf}
\caption{Ulike typer alvorlig infeksjon registrert i 2018}
\end{figure}


<<'Tab: andel utfort ymse', results='asis', echo=FALSE>>=
nysyke <- Inklusjon[which(abs(difftime(Inklusjon$Diagnose_Klinisk_Dato, Inklusjon$InklusjonDato, units = 'days')) <= 30), ]
antall_nysyke_anca <- length(which(nysyke$Diag_gr_nr == 2))
...
aux$samlet <- aux$UlMellomstoreKar != 'None' | aux$CtMellomstoreKar != 'None' | aux$CtAorta != 'None' |
  aux$MrMellomstoreKar!='None' | aux$MrAorta != 'None'
...
aux$samlet <- aux$BlodKar!='None' | aux$MrMellomstoreKar!='None' | aux$UlMellomstoreKar!='None'
...
## 2018:
# rad1<- colMeans(Inklusjon[Inklusjon$FormDate >= '2018-01-01' &  Inklusjon$FormDate <='2018-12-31', c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
# rad2<- colMeans(Oppfolging[Oppfolging$FormDate >= '2018-01-01' &  Oppfolging$FormDate <='2018-12-31', c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
#
# rad3<- colMeans(Inklusjon[Inklusjon$FormDate >= '2018-01-01' &  Inklusjon$FormDate <='2018-12-31' & Inklusjon$Tretthet!=0 & Inklusjon$PasientGlobalSykdomsaktivitet!=0 & Inklusjon$Pasientsmerter!=0,
#                    c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
# rad4<- colMeans(Oppfolging[Oppfolging$FormDate >= '2018-01-01' &  Oppfolging$FormDate <='2018-12-31' & Oppfolging$Tretthet!=0 & Oppfolging$PasientGlobalSykdomsaktivitet!=0 & Oppfolging$Pasientsmerter!=0,
#                     c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)


nysyke <- Inklusjon[which(abs(difftime(Inklusjon$Diagnose_Klinisk_Dato, Inklusjon$InklusjonDato, units = 'days')) <= 30), ]
nysyke <- nysyke[nysyke$FormDate >= '2017-01-01' &  nysyke$FormDate <='2018-12-31', ]

Oppfolging2018 <- Oppfolging[which(Oppfolging$PasientGUID %in% nysyke$PasientGUID), ]

rad1<- colMeans(nysyke[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)

rad2<- colMeans(Oppfolging2018[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)

rad3<- colMeans(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0,
                   c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)
rad4<- colMeans(Oppfolging2018[Oppfolging2018$Tretthet!=0 & Oppfolging2018$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2018$Pasientsmerter!=0,
                    c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], na.rm = T)



proms <- bind_rows(rad1, rad2,rad3,rad4)
proms$Navn <- c('gj.sn.inklusjon', 'gj.sn.oppflg', 'gj.sn.inklusjon_uten0', 'gj.sn.oppflg_uten0')
proms <- proms[, c(4,1,2,3)]

n1 <- apply(nysyke[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], 2, function(x) {sum(!is.na(x))})
n2 <- apply(Oppfolging2018[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], 2, function(x) {sum(!is.na(x))})
...
n4 <- apply(Oppfolging2018[Oppfolging$Tretthet!=0 & Oppfolging$PasientGlobalSykdomsaktivitet!=0 &
                         Oppfolging$Pasientsmerter!=0,
                    c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')], 2, function(x) {sum(!is.na(x))})

proms$N <- c(n1[1],n2[1],n3[1],n4[1])

print(xtable::xtable(proms, align= c('l','l',rep('r', ncol(proms)-1)), digits=1, caption='Gjennomsnitt av pasientsvar. De to øverste radene angir verdien  basert på alle registreringer. De to siste er  basert på et utvalg der besvarelser med verdi 0 er ekskludert. Dette er gjort siden det er uvisst om 0 er en reell verdi eller om det betyr at variabelen ikke er utfylt.'), include.rownames = F)


#  Versjon 2 -  Samme utvalg i pre -og postgruppen

nysyke <- nysyke[which(nysyke$PasientGUID %in% Oppfolging2018$PasientGUID), ]
...
print(xtable::xtable(proms, align= c('l','l',rep('r', ncol(proms)-1)), digits=1, caption='Gjennomsnitt av pasientsvar, med samme pasienter i Inklusjon -og oppfølgingsgruppen De to øverste radene angir verdien  basert på alle registreringer. De to siste er  basert på et utvalg der besvarelser med verdi 0 er ekskludert. Dette er gjort siden det er uvisst om 0 er en reell verdi eller om det betyr at variabelen ikke er utfylt.'), include.rownames = F)


######### signifikanstest  ##########################

tesres1 <- t.test(nysyke[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], Oppfolging2018[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], alternative = 'greater')

tesres2 <- t.test(nysyke[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], Oppfolging2018[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], alternative = 'greater')

tesres3 <- t.test(nysyke[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], Oppfolging2018[, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], alternative = 'greater')



tesres1_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], Oppfolging2018[Oppfolging2018$Tretthet!=0 & Oppfolging2018$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2018$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[1]], alternative = 'greater')

tesres2_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], Oppfolging2018[Oppfolging2018$Tretthet!=0 & Oppfolging2018$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2018$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[2]], alternative = 'greater')

tesres3_0 <- t.test(nysyke[nysyke$Tretthet!=0 & nysyke$PasientGlobalSykdomsaktivitet!=0 & nysyke$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], Oppfolging2018[Oppfolging2018$Tretthet!=0 & Oppfolging2018$PasientGlobalSykdomsaktivitet!=0 & Oppfolging2018$Pasientsmerter!=0, c('Tretthet', 'PasientGlobalSykdomsaktivitet', 'Pasientsmerter')[3]], alternative = 'greater')

# tibble(Navn = c('p_verdi_ensidig_t_test', 'p_verdi_ensidig_t_test_uten0'), Tretthet=c(tesres1$p.value, tesres1_0$p.value), PasientGlobalSykdomsaktivitet=c(tesres2$p.value, tesres2_0$p.value), Pasientsmerter=c(tesres3$p.value, tesres3_0$p.value))
